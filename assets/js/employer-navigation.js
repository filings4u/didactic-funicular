...
<nav class="admin-nav" aria-label="Admin navigation">
  ...
  <section class="admin-nav-group" data-nav-group="operations">
    ...
    <div class="admin-nav-group-items" id="admin-nav-operations">
      <a href="${prefix}employer-dashboard.html" data-nav-page="employer-dashboard.html">
        Dashboard
      </a>
      <a href="${prefix}employer-account.html" data-nav-page="employer-account.html">
        My Account
      </a>
      <a href="${prefix}employer-orders.html" data-nav-page="employer-orders.html">
        My Orders
      </a>
      <a href="${prefix}employer-employees.html" data-nav-page="employer-employees.html">
        Employees
      </a>
      <a href="${prefix}employer-locations.html" data-nav-page="employer-locations.html">
        Locations
      </a>
      <a href="${prefix}employer-team.html" data-nav-page="employer-team.html">
        My Team
      </a>
    </div>
  </section>
  ...
  <section class="admin-nav-group" data-nav-group="dot-compliance">
    ...
    <div class="admin-nav-group-items" id="admin-nav-dot-compliance">
      <a href="${prefix}employer-drivers.html" data-nav-page="employer-drivers.html">
        Drivers
      </a>
      <a href="${prefix}employer-post-accident-request.html" data-nav-page="employer-post-accident-request.html">
  ...
  <section class="admin-nav-group" data-nav-group="training">
    ...
    <div class="admin-nav-group-items" id="admin-nav-training">
      <a href="${prefix}employer-training.html" data-nav-page="employer-training.html">
        My Training
      </a>
      <a href="${prefix}employer-training-certificates.html" data-nav-page="employer-training-certificates.html">
  ...
  <section class="admin-nav-group" data-nav-group="communications">
    ...
    <div class="admin-nav-group-items" id="admin-nav-communications">
      <a href="${prefix}employer-support-tickets.html" data-nav-page="employer-support-tickets.html">
        Support Tickets
      </a>
    </div>
  </section>
  ...
  <section class="admin-nav-group" data-nav-group="content">
    ...
    <div class="admin-nav-group-items" id="admin-nav-content">
      <a href="${prefix}employer-documents.html" data-nav-page="employer-documents.html">
        My Documents
      </a>
    </div>
  </section>
  ...
  <section class="admin-nav-group" data-nav-group="system">
    ...
    <div class="admin-nav-group-items" id="admin-nav-system">
      <!-- No employer pages currently belong in this section. -->
    </div>
  </section>
...
function initializeAdminNavigationLogout() {
  ...
  button.addEventListener("click", async () => {
    ...
    try {
      ...
      window.location.href = getAdminPathPrefix() + "employer-login.html";
    }
  });
}
