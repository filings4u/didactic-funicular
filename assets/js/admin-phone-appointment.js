/* ============================================================
   SCREENINGS4U — PHONE APPOINTMENT BUILDER
  ...
  function fill(appointment) {
    if (E.pageTitle) {
      E.pageTitle.textContent =
        `${appointment.tracking_number || "Appointment"} — ${appointment.title || "Phone Appointment"}`;
    }
